...
namespace SmartBusBaseLib
{
    public class CreateMobileID
    {
        ...
        public string GetMobileIDNumberCode12()
        {
            //12位的随机数字
            Random NewRandom = new Random(System.Environment.TickCount);
            int MyGetRandom1 = NewRandom.Next(10000000, 99999999);//8位
            int MyGetRandom2 = NewRandom.Next(10, 99);//2位
            return RandomPreStr+MyGetRandom2.ToString() + MyGetRandom1.ToString();
