...
namespace HellaApcECOLib
{
    public class LGJUUIDUtis
    {
        ...
        public static string GetMobileIDCode6()
        {
            //6位的随机数字
        ...
        public static string GetMobileIDNumberCode8()
        {
            //8位的随机数字
            Random NewRandom = new Random(System.Environment.TickCount);
        ...
        public static string GetMobileIDNumberCode15()
        {
            //15位的随机数字
            Random NewRandom = new Random(System.Environment.TickCount);
        ...
        public static string GetMobileIDNumberCode12()
        {
            //12位的随机数字
            Random NewRandom = new Random(System.Environment.TickCount);
            //int MyGetRandom1 = NewRandom.Next(10000000, 99999999);//8位
            int MyGetRandom2 = NewRandom.Next(100000, 999999);//6位
            int MyGetRandom3 = NewRandom.Next(1000, 9999);//4位
            //string PreStr = "11";
            return "11" + MyGetRandom2.ToString() + MyGetRandom3.ToString();
